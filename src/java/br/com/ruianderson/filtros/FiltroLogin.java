 ...
 */
package br.com.ruianderson.filtros;
 ...
 * @author Rui
 */
@WebFilter(filterName = "FiltroLogin", urlPatterns = {"/restrito/*"})
public class FiltroLogin implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        Usuario usrfil  = (Usuario) req.getSession().getAttribute("usuariologado");
